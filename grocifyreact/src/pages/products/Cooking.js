      ...
      {/* model for filter */}
          ...
          <div className='ms-5'>
            <div>
              ...
              <label for="tropicana" className='form-label mx-2 '>Grains,flours & pulses</label>
            </div>
        
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Oils,Ghee & Fats</label>
            </div>        
  
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Masalas & Seasonings</label>
            </div>
           
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Baking essentials</label>
            </div>
