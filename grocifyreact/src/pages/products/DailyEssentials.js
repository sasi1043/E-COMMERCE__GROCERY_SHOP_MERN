...
function DailyEssentials() {
  ...
  return (
    ...
    {/* Navbar */}
      ...
      <h3 className='mt-3'>Daily Essential Products</h3>
        ...
        <div >
         ...
         <div className='ms-5'>
            <div>
              ...
              <label for="tropicana" className='form-label mx-2 '>Dairy Products</label>
            </div>
           
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Bakery & Bread</label>
            </div>
           
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Sugar & Sweeteners</label>
            </div>
