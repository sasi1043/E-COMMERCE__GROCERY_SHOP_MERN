...
//model for filetr in small screen
  ...
  return (
    ...
    {/* Navbar */}
      ...
      <h3 className='mt-3 heading' >Refreshing Beverages for Every Occasion</h3>
      ...
      <div className='d-flex'>
        ...
        <div className='mx-2 mt-2  p-2 rounded  head-filter' >
           <form className='mt-1'>
             ...
             <label style={{marginLeft:"5px"}}  for="Popular">Summer Specials</label>
           </form>
        </div>
        <div className='mx-2 mt-2 p-2 rounded head-filter'>
           <form >
          ...
          <div className='mt-2 p-2 rounded filter-btn'>
            <Button variant='outline-inherit' onClick={handleOpen} style={{backgroundColor:theme==="light"?"#fff":"#333",color:theme==="light"?"#222":"#fff"}}> <TuneIcon />Filter</Button>
        </div>
        ...
        <div >
          ...
          <div className='ms-5'>
           <div>
              ...
              <label for="tropicana" className='form-label mx-2 '>Energy Drink</label>
            </div>
           <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Nutritional Drink</label>
            </div>
           <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Soft Drink</label>
            </div>
           <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Fruit Juice</label>
            </div>
           <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Energy Drink</label>
...
{/* end of model for filter */}
      ...
      <div className='container mt-2 ms-1 me-1 rounded' style={{height:"550px",width:"300px",position:"fixed",border:"solid lightgray 1px"}}>
        <div>
          <h5 className='mt-3 ms-3'>Categories</h5>
           <div className='ms-5'>
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Energy Drinks</label>
            </div>
                
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Nutritional Drinks</label>
            </div>
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Soft Drinks</label>
            </div>
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Fruit juice</label>
          ...
          <div className='card border-secondary w-100 h-100'>
            ...
            <div className='card-body' style={{backgroundColor:theme==="light"?"#fff":"#333",color:theme==="light"?"#222":"#fff"}}>
              ...
              <div className='d-flex justify-content-between  align-items-center' style={{backgroundColor:theme==="light"?"#fff":"#333",color:theme==="light"?"#222":"#fff"}}>
                ...
                <button className='addcart' style={{borderRadius:"25px"}} onClick={()=>{addCart(item);snackClick();}}>Add To Cart</button>
                <Snackbar
        open={snack}
