        ...
        <div >
          ...
          <div className='ms-5'>
            <div>
              ...
              <label for="tropicana" className='form-label mx-2 '>Liquid Milk</label>
            </div>
                
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Butter</label>
            </div>
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Chees & Paneer</label>
            </div>
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Milk Powder</label>
            </div>
          </div>
        </div>
