...
function Chocolates() {
  ...
  const {theme}=useTheme();
    ...
    async function load(){
        try{
            const res =await axios.get(`${API}/api/products/choco`);
            setChoc(res.data);
        }
        catch(e){
            console.error(e);
      ...
      <div className='container ms-1 me-1  mt-2 rounded' style={{height:"550px",width:"300px",position:"fixed",border:"solid lightgray 1px"}}>
        ...
        <div >
          ...
          <div className='ms-5'>
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Dairy Milk</label>
            </div>
          
           
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Kinder Joy</label>
            </div>
          
           
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Milky Bar</label>
            </div>
          
           
            <div>
              <input type='checkbox' for="tropicana" className='form-check-input border-dark'></input>
              <label for="tropicana" className='form-label mx-2 '>Galaxy</label>
            </div>
        ...
        {choc.map((ch)=>(
          ...
          <div className='card border-secondary w-100 h-100' style={{maxWidth:"250px"}}>
            <div className='card-header' style={{backgroundColor:theme==="light"?"#fff":"#333",color:theme==="light"?"#222":"#fff",textAlign:"center"}}>
              <img src={`${API}/${ch.path}`} alt='apple'  className='img-prod' height={150} width={150}></img>
            </div>
            <div className='card-body' style={{backgroundColor:theme==="light"?"#fff":"#333",color:theme==="light"?"#222":"#fff"}}>
              ...
              <div className='d-flex justify-content-between  align-items-center'>
                ...
                <button className='addcart' style={{borderRadius:"25px"}} onClick={()=>addCart(ch)}>Add To Cart</button>
              </div>
            </div>
          </div>
        </div>
